...
#define VOLTAGE_READER_PIN_5V A6
#define VOLTAGE_READER_PIN_3V7 A7
#define EXTERNAL_THERMISTOR_PIN A0
...
int gpsBaud = 38400;     // 9600 for M8 & 38400 for M9 GPS
byte gpsStatus = 0;
...
int ecefX = 999, ecefY = 999, ecefZ = 999;
//double posAcc = 999;
int SIV = 0;
...
bool rtkEnabled = false; // bool to enable turing off RTK for debugging
...
// OLED
OLED OLED;   // Input the pins that the MS5611 is using
